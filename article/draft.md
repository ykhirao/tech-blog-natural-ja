...
この記事は「いつ何が起きたか」を何度も比べます。
読みながら参照できるよう、外の出来事を先に並べておきます。

| 年月 | 出来事 |
|------|--------|
| 2016年3月 | AlphaGo がイ・セドル九段に4勝1敗 |
| 2016年11月 | Google 翻訳がニューラル機械翻訳に切り替え(日本語を含む8言語) |
| 2017年6月 | Transformer の論文(Attention Is All You Need)が arXiv に公開 |
| 2020年3月 | DeepL が日本語に対応 |
| 2021年6月 | GitHub Copilot の技術プレビュー公開 |
| **2022年11月** | **ChatGPT 公開** |
| 2023年3月 | GPT-4 公開 |
| 2023年7月 | Claude 2 公開 |
| 2024年6月 | Claude 3.5 Sonnet 公開 |
| **2025年2月** | **Claude Code 公開** |
| 2025年5月 | Claude 4 系公開 |

Qiita のデータは2011年から2026年9月まであります。
この年表の全部を含む期間です。

なお、この記事で何度も出てくる「2022年11月」は ChatGPT の公開月です。
分析の基準として使っているのはそれだけで、
**他の出来事と結びつけて説明はしていません**。
後から日付を合わせるのは簡単すぎるからです。

> 年表の日付は公開時の発表で確認しています。
> AlphaGo は2016年3月9〜15日の5局、Transformer の論文は arXiv 2017年6月12日、
> Google 翻訳の切り替えは2016年11月(日本語を含む8言語)、
> DeepL の日本語対応は2020年3月、GitHub Copilot は2021年6月29日、
> ChatGPT は2022年11月30日、GPT-4 は2023年3月14日です。

結論を先に5つ書きます。

1. 文のリズムを表す指標が、ChatGPT の公開より**3か月早く**下がり始めている
...
### 使ってもらって構いません、あと手伝ってください

スクリプト・集計結果・閾値の校正データは全部ここに置いてあります。

**https://github.com/ykhirao/tech-blog-natural-ja**

MIT なので、別の期間・別のプラットフォーム(Zenn でも note でも社内 Wiki でも)で
同じ測り方を回してもらって構いません。結果が違ったらぜひ教えてください。

そのうえで、**コメント欄をもらえると助かります。**
この記事で測れたのは、自分が思いついた仮説のぶんだけです。
実際、記事の中で試した仮説は半分くらい外れていて、
外れるたびに次の測定が決まっていました。だから思いつきが増えるほど精度が上がります。

こういうのが特に助かります。

> **「こういう仮説はどうか」**
> 例:「2026年の変化は、特定のツールの普及で説明できるのでは?」
> — 対抗仮説は歓迎です。この記事でも4つぶつけて、4つとも外れました。

> **「この言葉は AI 用語ではないか」**
> 例:「"〜の際には" が増えている気がする」
> — 語を挙げてもらえれば、**811,379本・189か月分で実測します。**
> 増えていればルールに足し、増えていなければ足しません。
> 増えたことと直すべきことは別なので。

> **「ここが AI っぽい」**
> — 具体的な箇所が分かれば、それが本当に増えているのかをまず測ります。
> 指標に乗っていない特徴なら、次の校正に使えます。

コメントに書きにくいことや、データを見せたいときは
[X の @ykhirao](https://x.com/ykhirao) まで DM でも大丈夫です。全部見ます。
...
![設計・判断・整理・検証・運用の推移](https://i.imgur.com/vMnbFsI.png)
...
文長のばらつきが2022年に下がり始めたのとは、まったく別の動きです。
...
この記事の前半で「2022年に動いた」と書いた変化より、こちらのほうが急です。
...
**10本以上書く層だけが大きく動いています。** この層を除くと、
朝の増加は +9.9ポイントから +3.6ポイントまで縮みます。
増加分の約64%がこの層によるものです。

なぜ大量に書く人が朝に投稿するようになったのかは分かりません。
...
手元にある最後の月を見ました。2026年9月14日まで、4,668本です。
9月15日はデータを取った当日なので除いています。
...
体言止めと読点はまだ動いています。頭打ちの兆しはありません。
一方で文長のばらつき・漢字率・地の文字数は8月とほぼ同じ。
**指標によって、止まったものと続いているものがあります。**

これが手元のデータで見られる最後の月です。この先は分かりません。
...
![仕組み・流れ・構造・構成の推移](https://i.imgur.com/DirkVyN.png)
...
![ツール・ライブラリー・モジュール・ベースの推移](https://i.imgur.com/BKx7t8V.png)
...
作った lint にこの記事を通しました。**検出は1件です。**

その1件は「折れる」です。最後の節でその語について書いているため
何度か出てきます。禁止語を扱う文章はその語を使わずには書けないので、
直しません。それ以外はゼロでした。
...
**元から動いていたものと、2022年に向きが変わったものがあります。**
...
体言止めが3分の1になったなら、**その文は何で終わるようになったのか**。
文末表現を数えました。記事ごとに比率を出した中央値です。
...
**「です」が2.2倍**でいちばん動いています。
「ています」「ません」は2020年の中央値が0%でした。
半数以上の記事が一度も使っていなかったということです。
...
どちらが良いという話ではありません。ただし
**言い切りの形が減って、説明の形が増えた**とは言えます。

「でしょう」だけは減っています(0.31% → 0.15%)。推量を避ける方向です。

ただし因果は言えません。体言止めが減ったから「です」が増えたのか、
逆なのかは分かりません。同時に起きていることしか示していません。

### 引用が2倍、段落は1文に近づいた

引用と段落も測りました。

| 年 | 記事数 | 引用あり% | 段落の文数 | 画像あり% |
|----|-------|---------|----------|---------|
| 2015 | 611 | 13.1 | 1.40 | 32.7 |
| 2020 | 1,935 | 13.6 | 1.60 | 52.3 |
| 2022 | 1,387 | 14.9 | 1.62 | 52.1 |
| 2023 | 1,417 | 14.2 | 1.56 | 53.8 |
| 2024 | 1,673 | 11.5 | 1.43 | 50.7 |
| **2026** | 2,749 | **32.2** | **1.07** | **39.5** |

**引用を使う記事は11年間 11.5〜16.9% でした。** それが2026年に32.2%。

1段落あたりの文数は 1.62 → **1.07**。ほぼ1段落1文です。
改行で区切って並べる書き方に寄っています。

月ごとに見ると引用が跳ねたのは2026年3月で、
箇条書きの入れ子が落ちた時期と重なります。
**同じ時期に、記事の構造がまとめて動いています。**

### 「3月に何かあった」と思って調べたら、違った

複数の指標が同じ月を指しているので、何か起きたのかと思い
週ごとに測り直しました。**跳躍ではありませんでした。**

| 週 | 記事数 | 引用あり% | 入れ子あり% |
|----|-------|---------|-----------|
| 第01週 | 1,101 | 17.6 | 28.7 |
| 第05週(1/26〜2/1) | 2,119 | 23.6 | 29.0 |
| 第06週(2/2〜2/8) | 2,042 | 20.7 | 25.5 |
| 第07週(2/9〜2/15) | 2,171 | 24.2 | 22.0 |
| 第08週(2/16〜2/22) | 2,092 | 25.2 | **18.7** |
| 第10週(3/2〜3/8) | 2,218 | 30.9 | 19.8 |
| 第22週 | 2,321 | 32.7 | 14.2 |

入れ子がいちばん速く動いたのは第5週から第8週、**2月上旬から中旬**です。
3月ではありませんでした。体言止めも週次では滑らかに下がっていて
(0.102 → 0.079)、特定の週に段差はありません。

**月ごとに丸めたときに「3月」が目立っただけでした。**

この記事では月次を何度も使っていますが、
月の区切りは分析上の都合であって、変化がそこで起きる理由はありません。
週次で見ると別の時期が出てくることがあります。

画像を使う記事は2023年の53.8%から39.5%へ減りました。
元記事で「画像密度が半減した」と分かっていましたが、
**使う記事そのものが減っている**のは新しい発見です。

さらに外部に置かれた画像の割合がU字を描いていました。
...
11年かけて下がったものが、2年で元に戻っています。
2026年は GitHub の生ファイルや Zenn の静的配信が上位に来ます。

なお最初に測ったときは22.8%でした。中身を見ると
**1つのホストが623件**を占めていて、**2人の著者の15本**によるものでした。
1記事10件で打ち切って14.8%です。それでも7.8倍なので、
外れ値だけでは説明できません。

### 箇条書きは数が増え、入れ子は消えた

見出しの階層が浅くなったので、箇条書きも同じか確かめました。
入れ子は「使う記事の割合」で測ります。中央値だと半数以上が0段で
差が出ないためです。

| 年 | 記事数 | 入れ子あり% | 深さ2以上% | 箇条書き数 |
|----|-------|-----------|----------|----------|
| 2015 | 346 | 13.9 | 7.5 | 6 |
| 2020 | 1,074 | 23.8 | 16.4 | 7 |
| 2023 | 767 | 23.6 | 17.9 | 8 |
| 2024 | 996 | 28.6 | 18.6 | 9 |
| **2025** | 1,440 | **32.2** | 17.3 | **13** |
| **2026** | 2,202 | **11.0** | **4.2** | **14** |

**入れ子を使う記事が3分の1になりました。** 深さ2以上は4分の1以下です。

一方で箇条書きの数は6個から14個へ増えています。
**数は倍以上になったのに、構造は平らになった。**

月ごとに見ると2026年2月から4月の3か月で半減しています。
体言止めや読点が動いたのと同じ時期です。

字下げの分布を見ると、判定の仕方によりません。
...
見出しの階層(46.1% → 36.5%)と箇条書きの入れ子(32.2% → 11.0%)が
同じ方向に動いています。**入れ子をやめて、同じ高さで並べる方向**です。

### コードは減り、コードでないものが枠に入るようになった

地の文が2倍になったことは測りましたが、
**コードのほうがどうなったか**は測っていませんでした。
...
**地の文が倍近くなる一方で、コード行数は37行から20行へ減っています。**
技術記事の中身が、コードから文章へ移りました。

言語指定の書き方も変わりました。2015年から2025年まで25〜37%だった
「言語を書かない」が、2026年に15.2%へ半減しています。

何が増えたのかを見ると、意外なものでした。

| 年 | text | bash | python | mermaid |
|----|------|------|--------|---------|
| 2015 | 2.6% | 10.1% | 0.0% | 0.00% |
| 2020 | 0.6% | 4.9% | 6.0% | 0.00% |
| 2024 | 0.8% | 8.2% | 12.4% | 0.25% |
| 2025 | 1.5% | 9.7% | **18.6%** | 0.55% |
| **2026** | **18.9%** | 15.8% | 6.8% | **3.58%** |

**`text` が11年間 0.4〜3.2% だったのが、2026年に18.9%。** 12倍です。

中身を見ると、ファイル一覧・実行結果・ディレクトリ構成でした。
**コードではないものを、コードブロックに入れています。**

「コードではない」を数えました。ブロックの中身のうち
日本語(かな・漢字)が3割を超えるものを数えます。
コードなら日本語はほとんど出ません。
...
`text` の増加と日本語ブロックの増加は同じ現象でした。

短さも目立ちます。`text` ブロックの **33%が1行だけ**です。
「インストール」「/bin/zsh」「Error code: 410」のような短い文字列を
枠で囲っている。

### 太字と入れ替わったのかと思ったら、併用でした

日本語ブロックも太字も「枠で囲って目立たせる」手段なので、
どちらかがどちらかを置き換えたのかと思って測りました。**逆でした。**

2026年8月の記事を、日本語ブロックを使うかで分けます。

| 指標 | あり(3,302本) | なし(6,962本) |
|------|--------------|--------------|
| 太字/千字 | **2.554** | 1.046 |
| 見出し数 | **15** | 9 |
| 地の文字数 | **2,611** | 1,805 |
...
日本語ブロックを使う記事は**太字が2.4倍、見出しが1.7倍**。
入れ替わりではなく、同じ記事に同居しています。
**「装飾を多用する記事」という一つの型**があります。

さらに過去の年で同じ比較をすると、太字の差が消えました。

| 月 | 日本語ブロックあり | 太字(あり vs なし) |
|----|-----------------|------------------|
| 2020-08 | 720本 (10.4%) | **0.00 vs 0.00** |
| 2024-08 | 675本 (12.2%) | **0.00 vs 0.00** |
| **2026-08** | 3,302本 (32.2%) | **2.55 vs 1.05** |

2020年と2024年は、日本語ブロックを使う記事も使わない記事も
太字の中央値が0.00でした。半数以上がまったく使っていない。

**2026年に初めて差がつきました。** この型は昔からあったのではなく、
2026年に生まれています。

### 装飾は「型」ではなく連続した軸だった

日本語ブロック・引用・mermaid のうちいくつ使うかで分けると、
きれいな単調関係が出ました。

| 装飾の数 | 記事数 | 割合 | 太字/千字 | 見出し数 | 地の文字数 |
|---------|-------|------|----------|---------|----------|
| 0個 | 4,529 | 44.1% | 0.63 | 9 | 1,714 |
| 1個 | 3,456 | 33.7% | 1.91 | 12 | 2,200 |
| 2個 | 1,720 | 16.8% | 3.38 | 16 | 2,886 |
| 3個 | 307 | 3.0% | **4.82** | **19** | **3,894** |

太字は7.6倍。2つの型に分かれるのではなく、**連続した軸**です。

過去の年で同じ分け方をすると、**軸そのものが存在しません。**

| 月 | 0個 | 1個 | 2個 |
|----|-----|-----|-----|
| 2020-08 | 72.0%(太字 0.00) | 18.7%(0.00) | 1.6%(0.72) |
| 2024-08 | 71.9%(太字 0.00) | 20.3%(0.00) | 2.1%(0.00) |
| **2026-08** | **44.1%(0.63)** | **33.7%(1.91)** | **16.8%(3.38)** |

2020年と2024年は装飾を1つも使わない記事が72%を占め、
2つ使っても太字の中央値は0.00のままでした。**装飾どうしが連動していない。**

### 軸が生まれたのは2025年前半

2020年と2026年の間のどこで生まれたのかを月次で追いました。
太字は中央値が0の年があるので、**使う記事の割合**で測ります。
...
**2024年8月は順序が乱れています。** 装飾2個(39%)が1個(42%)より低い。
軸になっていません。

2025年2月に 44% / 51% / 63% と単調になり、以降その形を保っています。
**軸が生まれたのは2025年前半**でした。

### 量のピークは2026年1月で、そこから減っている

使う人の割合ではなく**量**で見ると、別の形が出ました。
...
2026年1月がピークです。「使う人は増えたが量は減った」ように見えます。

同じ人が控えめになったのか、書き手が入れ替わったのかを分けました。
2026年1月と8月の両方に投稿した **625人**の、本人の中での変化です。

| | 中央値 | 減らした人 |
|---|-------|----------|
| 本人内の太字の変化 | **+0.000** | 44% |

**動いていませんでした。** 減らした人が44%でほぼ五分です。
...
記事数が3.5倍に増える一方で、太字を多用する記事の割合は落ちています。
**装飾を使い始めた人が増え、その人たちは太字をそこまで使わない。**
先行していた層が薄まった形です。

これは記事の前半で見た「同じ人が半年で書き方を変えた」のとは逆です。
**指標によって、本人が変わるものと書き手の構成が変わるものがあります。**

### 全指標で分けたら、きれいに3つになった

両方が出てきたので、全指標で確かめました。
2026年2月と8月の両方に投稿した **758人**の本人内変化です。

「本人内で動いた割合」は全体と同じ向きに動いた著者の割合で、
偶然なら50%になります。
...
**上の4つは本人が変えていました。** どれも文章そのものの性質です。

**下の2つは本人内で動いていません。** 全体で動いて見えるのは、
違う書き方をする人が増えたからです。どちらも装飾です。

漢字率と MTLD はほぼ五分で、判定できませんでした。

**「文章の書き方」は本人が変え、「装飾」は人が入れ替わった。**

きれいに分かれたのは予想外でした。装飾のほうが真似しやすいので
本人が取り入れると思っていましたが、逆です。

装飾は書き始める時点の型で決まり、文章の書き方は書きながら変わる、
という説明はできますが、**検証していません**。

### ただし記事長を揃えると、残るのは太字だけ

長い記事ほど装飾を使う機会が多いので、
地の文1,500〜3,000字に揃えて測り直しました。

| 装飾の数 | 太字/千字 | 見出し数 | 体言止め |
|---------|----------|---------|---------|
| 0個 | 0.76 | 10 | 0.048 |
| 1個 | 1.85 | 12 | 0.046 |
| 2個 | 3.50 | 14 | 0.039 |
...
太字は5.9倍で残りますが、見出し数は 10 → 14 と大きく縮みました
(揃える前は 9 → 19)。**見出しの差はほぼ記事長で説明がつきます。**

装飾の軸と強く結びついているのは**太字だけ**でした。

mermaid(図を描くブロック)も 0.55% → 3.58% で6.5倍です。

### 見出しも、タイトルと同じ時期に動いた

本文とタイトルを測ったので、見出しも測りました。

| 年 | 記事数 | 見出し数 | 見出しの長さ | ###以下% |
|----|-------|---------|------------|---------|
| 2014 | 306 | 6 | 10 | 28.4 |
| 2017 | 691 | 7 | 10 | 26.7 |
| 2020 | 1,424 | 7 | 9 | 33.7 |
| 2022 | 1,285 | 7 | 10 | 32.3 |
| 2023 | 1,307 | 7 | 9 | 32.1 |
| 2024 | 1,553 | 8 | 9 | 39.6 |
| **2025** | 1,891 | **10** | **11** | **46.1** |
| **2026** | 2,632 | **11** | **14** | **36.5** |

**長さは2014年から2024年まで9〜10字。11年間で1字も動いていません。**
それが2025年に11字、2026年に14字になりました。個数も7個から11個へ。

太字(2024年末)・タイトル(2024〜2025年)・見出し(2024年後半)。
**見た目に関わるものが、同じ時期にそろって動いています。**

階層は予想と逆でした。`###` 以下の深い見出しは2025年の46.1%まで
増えたあと、2026年に36.5%へ落ちています。
見出しの数は増えているのに、階層は浅くなった。
`##` を並べる書き方に寄っています。

### 公開後に直さない記事が2倍に増えた

文章そのものではなく、**書いたあとの行動**も測れます。
Qiita API は公開日時と更新日時を返すので、
一度も直していない記事が分かります。

| 年 | 記事数 | 未更新% | 後日更新% |
|----|-------|--------|---------|
| 2013 | 1,133 | 42.3 | 38.8 |
| 2015 | 4,067 | 35.9 | 47.8 |
| **2017** | 4,822 | **32.1** | **49.8** |
| 2019 | 9,309 | 37.3 | 46.1 |
| 2021 | 8,145 | 38.2 | 46.7 |
| 2023 | 6,920 | 45.1 | 41.1 |
| 2024 | 7,815 | 46.9 | 38.6 |
| **2026** | 11,569 | **64.4** | **24.5** |

**2017年の32.1%を底に、9年間ずっと上がり続けています。**
1時間以上あとに直す「後日更新」は逆に 49.8% → 24.5% で半減。

書いて出してそれきり、という記事が増えました。

注意点があります。データを取ったのは2026年9月14日なので、
新しい記事ほど更新の機会が少ない。2025年以降の値はこの影響を含みます。
ただし**2017年から2024年の 32.1% → 46.9% は、どの年も6年以上
経っているので比較できます**。この範囲だけでも1.5倍です。

そして**この指標がいちばん早く動いています**。
...
本文の体言止めが動き出した2022年にも、タイトルは動いていない。

数字を含むタイトルも増えました。2015年から2024年まで26〜27%で
一定だったものが、2026年は37.0%です。

これは「Python 3.12 のようなバージョン番号が増えただけ」かもしれないので、
数字の用法を分類しました。

| 年 | 数字% | 日付 | 連載回 | 版番号 | 数え上げ |
|----|------|-----|-------|-------|--------|
| 2015 | 26.4 | 0.37 | 1.23 | **9.57** | 0.68 |
| 2020 | 27.2 | 0.43 | 1.39 | 8.39 | 0.68 |
| 2022 | 27.2 | 0.57 | 1.20 | 7.84 | 0.78 |
| 2024 | 26.6 | 0.71 | 1.08 | 7.38 | 0.87 |
| 2026 | **37.0** | **2.52** | **2.34** | 8.56 | **2.99** |

**版番号は増えていませんでした。** 15年間 7.1〜9.6% の幅に収まっていて、
2026年の 8.56% はむしろ2015年(9.57%)より低い。

増えたのは数え上げ(0.87 → 2.99、3.4倍)と日付(0.71 → 2.52、3.5倍)です。
「7つのルール」「4つの機械的ゲート」のような型が本当に増えていました。

判定を厳しくしても緩くしても同じ結論でした
(2024年 0.91% → 2026年 3.24%、または 1.14% → 4.05%)。
...
- 文長のばらつきは2022年8月に下がり始めていて、これは AI 公開の3か月前にあたる
...
- タイトルの数字が増えたのは**数え上げ**が増えたため。
  バージョン番号は15年間ほぼ一定だった
- **公開後に直さない記事が2倍に増えた。** 2017年に底を打っていて、
  生成AIより5年早く動き出している
- 体言止めが減ったぶんは「です」に置き換わった(2.2倍)
- **見出しの長さは11年間9〜10字で不変**、2025年から動き出した。
  太字・タイトルと同じ時期
- **コード行数は半減し、`text` タグのブロックが12倍に増えた。**
  コードでないものがコードブロックに入るようになった
- **入れ子が消えた。** 見出しの階層も箇条書きの入れ子も2025年が最大で、
  2026年に浅くなった。数は増えているのに構造は平らになっている
- **引用が2倍、段落は1段落1文に近づいた。** 画像を使う記事は減り、
  外部に置かれた画像の割合はU字を描いて元に戻った
- **装飾は連続した軸になっていて、その軸は2025年前半に生まれた。**
  記事長を揃えると、軸と結びついているのは太字だけ
- **指標によって、本人が変わるものと書き手の構成が変わるものがある。**
  体言止めは同じ人が変えたが、太字の量は層の入れ替わりだった
...
逆に「ここが AI っぽい」と感じた箇所があれば、
**コメント欄に書いてもらえると助かります。**
それは指標に乗っていない特徴なので、次の校正に使えます。
...
具体的な箇所が分かれば、まず**それが本当に増えているのかを実測します**。
増えていれば lint のルールに足し、増えていなければ足しません。
増えたことと直すべきことは別なので。

実際、この記事を書いている途中でも指摘を受けました。
「burstiness という英語をそのまま使うな」
「〜だけは、という言い方が AI っぽい」
「折れている、という表現は使わない」。
...
| 指摘 | 実測 | 対応 |
|------|------|------|
| 「〜だけは」 | 2020→2026で5.49倍 | ルールに追加 |
| 「という事実」 | 7.19倍 | ルールに追加 |
| 「折れている」 | 12年間0.4%未満。10件中9件が「心が折れる」 | ルールに追加 |

最後の「折れている」は増えてもいませんでした。
グラフが下がり始めることを「折れる」と書くのは相場のチャート用語で、
技術記事では誰も使っていない。**自分は23箇所使っていました。**

指摘されるまで気づかず、測って初めて分かりました。
思いつきで直すと別の癖が入るので、必ず測ってからルールにしています。

なおこの節を書いたことで、記事の自己 lint が1件出るようになりました。
「折れる」を何度か使っているためです。ただし全部**その語について書いている**
箇所なので直しません。禁止語を扱う文章は、その語を使わずには書けない。
...
仮説でも、AI 用語っぽい語の心当たりでも、「ここが AI っぽい」でも、
コメント欄か [X の @ykhirao](https://x.com/ykhirao) の DM までください。
挙げてもらった語は、思いつきで足さずに**まず81万記事で実測します。**
