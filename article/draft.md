# 生成AIより先に、日本語が変わっていた — Qiita 4.9万記事を12年分測った話
...
8月だけで合計 **49,739本**、月次のぶんを足すと10万本を超えます。
...
あとで全期間(2011〜2026年、184か月)を測り直したとき、
...
|------|--------------|------|------|
| 文長のばらつき | **-0.234 〜 -0.249** | -0.253 | -0.267 |
| 体言止め | **0.133 〜 0.158** | 0.133 | 0.069 |
...
書き手が増えて競争が激しくなったのか、読み手の行動が変わったのかは分かりません。
...
**AI 判定に使ってはいけない語**だと、傾きからも確認できます。
...
**2016年から2017年で2.3倍**になっています。そのあと2023年まで下がり続け、
2026年にまた跳ねる。
...
辞書の51エントリのうち、こちらのデータで測れた41語です。

| 順 | 語 | 2020年 | 2026年 | 倍率 |
|---|---|---|---|---|
| 1 | 正本 | 0.00% | 1.35% | **新規** |
| 2 | 帰結 | 0.00% | 0.95% | **新規** |
| 3 | 実測 | 0.08% | 8.17% | 104.7倍 |
| 4 | 突き合わせる | 0.04% | 3.84% | 98.6倍 |
| 5 | 線引き | 0.03% | 1.88% | 72.3倍 |
| 6 | 素通り | 0.04% | 1.40% | 35.9倍 |
| 7 | 核心 | 0.09% | 2.93% | 32.2倍 |
| 8 | 断定 | 0.09% | 2.91% | 32.0倍 |
| 9 | 構図 | 0.08% | 2.24% | 28.7倍 |
| 10 | 見落とす | 0.17% | 4.53% | 26.8倍 |
| 11 | 見張る | 0.03% | 0.67% | 25.9倍 |
| 12 | 破綻 | 0.10% | 2.62% | 25.2倍 |
| 13 | 黙る | 0.13% | 3.13% | 24.1倍 |
| 14 | 土台 | 0.26% | 5.85% | 22.5倍 |
| 15 | 照合 | 0.19% | 4.37% | 22.4倍 |
| 16 | 事故 | 0.35% | 7.04% | 20.1倍 |
| 17 | 混ざる | 0.27% | 5.38% | 19.7倍 |
| 18 | 定石 | 0.07% | 1.26% | 19.4倍 |
| 19 | 道具 | 0.31% | 5.93% | 19.1倍 |
| 20 | 潰す | 0.23% | 3.98% | 17.0倍 |
| 21 | 壊れる | 0.68% | 11.33% | 16.8倍 |
| 22 | 経路 | 0.77% | 12.01% | 15.7倍 |
| 23 | 疑う | 0.45% | 6.25% | 13.8倍 |
| 24 | 溶かす | 0.09% | 1.21% | 13.3倍 |
| 25 | 切り分ける | 0.39% | 5.14% | 13.2倍 |
| 26 | 落とし穴 | 0.29% | 3.77% | 13.2倍 |
| 27 | 踏み込む | 0.26% | 2.88% | 11.1倍 |
| 28 | 捨てる | 0.53% | 5.20% | 9.8倍 |
| 29 | 失う | 0.78% | 6.41% | 8.2倍 |
| 30 | 検査 | 0.64% | 4.94% | 7.8倍 |
| 31 | 止まる | 1.99% | 14.71% | 7.4倍 |
| 32 | 落ちる | 1.71% | 12.43% | 7.3倍 |
| 33 | 漏れる | 0.38% | 2.67% | 7.1倍 |
| 34 | 崩す | 0.19% | 1.22% | 6.2倍 |
| 35 | 定番 | 0.47% | 2.79% | 6.0倍 |
| 36 | 漏れ | 0.64% | 3.76% | 5.9倍 |
| 37 | 走る | 2.08% | 9.77% | 4.7倍 |
| 38 | 消える | 2.87% | 13.25% | 4.6倍 |
| 39 | 部品 | 1.32% | 4.37% | 3.3倍 |
| 40 | 死活 | 0.14% | 0.43% | 3.0倍 |
| 41 | 焼く | 0.19% | 0.54% | 2.8倍 |

**1語も減っていません。** 観察から作った辞書が、実測と完全に一致しました。

「正本」「帰結」は2020年8月の記事に1件も出てきません。
こちらが独立に見つけた「実測」(104.7倍)「経路」(15.7倍)とも重なります。

### 検出性能も測った

同じ200本ずつで比べます。

| 対象 | preset-ai-words-ja | こちらの構文ルール |
|------|-------------------|------------------|
| 2020年(AI以前)200本 | 12.5% | 3.0% |
| 2026年 200本 | **64.0%** | 17.0% |
| 比 | 5.1倍 | 5.7倍 |

語彙だけで64%を拾えるのは強力です。ただし2020年側の12.5%には
「走る」9件、「焼く」2件のような、技術記事では普通の動詞が混ざります。
...
正直に書くと、この記事を preset に通したら21件出ました。
ただし中身を見ると、大半は直せません。

| 箇所 | 内容 |
|------|------|
| `経路 0.9% → 10.5%` | 測定結果を載せた表 |
| 「実測」4件 | 手法の説明。言い換えると意味が変わる |
| 「効いています」 | ふつうの日本語 |
...
つまり**固有の外来語は伸びず、それをたとえた和語のほうが増えている**。
...
生き残り率は、**その語に選択の余地があるかどうか**を表しています。
...
184か月・70万件超)を測り直しています。

AI以前(2013→2021、8年)と以後(2021→2026、5年)の年あたり変化を並べます。

| 指標 | 2013 | 2021 | 2026 | AI前/年 | AI後/年 |
|------|------|------|------|--------|--------|
| 読点/文 | 0.536 | 0.520 | 0.783 | -0.0019 | **+0.0526** |
| MTLD | 44.73 | 43.12 | 51.99 | -0.2006 | **+1.7740** |
| 文長のばらつき | -0.242 | -0.234 | -0.267 | +0.0009 | **-0.0066** |
| 体言止め | 0.133 | 0.158 | 0.069 | +0.0031 | **-0.0178** |
| 漢字率 | 0.152 | 0.176 | 0.223 | +0.0030 | +0.0093 |
| 地の文字数 | 719 | 1,074 | 1,657 | +44.4 | +116.6 |

3つに分かれました。

**元から動いていた指標** — 漢字率、地の文字数

どちらも2013年から一貫して増えています。AI以後に加速しますが(3.1倍、2.6倍)、
...
AI以前の傾きがほぼゼロ(-0.0019)で、以後に +0.0526。
