...
| 2022と2026の比較 | [within-author-2022.md](within-author-2022.md)。別の形の変化だった |
| 装飾は入り口の型か | [decoration-entry.md](decoration-entry.md)。**外れた。**古参も変えている |
...
([decoration-entry.md](decoration-entry.md))。入り口で何が変わったのかは見ていない。
